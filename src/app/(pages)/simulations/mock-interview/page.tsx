...
export default function MockInterviewPage() {
  ...
  const renderSetup = () => (
    <Card className="max-w-xl mx-auto">
      <CardHeader>
        <CardTitle className="font-headline text-2xl">AI Mock Interview</CardTitle>
  ...
  const renderFeedback = () => {
    ...
    return (
      <Card className="max-w-3xl mx-auto w-full">
        <CardHeader>
           <CardTitle className="font-headline text-xl">Feedback on Your Answer</CardTitle>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700">
                ...
                <div>
                    <h4 className="font-bold text-green-800 dark:text-green-300">AI Feedback</h4>
